...
//
//     final unsplashModal = unsplashModalFromJson(jsonString);

import 'dart:convert';

List<UnsplashModal> unsplashModalFromJson(String str) => List<UnsplashModal>.from(json.decode(str).map((x) => UnsplashModal.fromJson(x)));

String unsplashModalToJson(List<UnsplashModal> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class UnsplashModal {
  ...
  factory UnsplashModal.fromJson(Map<String, dynamic> json) => UnsplashModal(
    id: json["id"],
    slug: json["slug"],
    ...
    links: json["links"] == null ? null : UnsplashModalLinks.fromJson(json["links"]),
    likes: json["likes"],
...
class UnsplashModalLinks {
  ...
  factory UnsplashModalLinks.fromJson(Map<String, dynamic> json) => UnsplashModalLinks(
    self: json["self"],
    html: json["html"],
